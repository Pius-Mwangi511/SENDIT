...
@Component({
  ...
  template: `
    ...
    <div class=" p-6 text-black">
      <div class="grid grid-cols-2 gap-4 bg-[rgba(37,38,65,0.1)] w-full border  rounded-lg shadow-xl">
        <div class="p-5">
      ...
      <h2 class="text-2xl font-semibold mt-8 mb-2 text-blue-600 text-center"> Our Mission</h2>
