...
@Component({
  selector: 'app-admin-sent-requests',
  standalone: true,
  imports: [
    RouterLink,
    NgFor,
    ...
    <div class="grid grid-cols-[215px,1200px] gap-4 mt-10">
      ...
      <div class="border border-black-600 rounded-xl bg-[rgba(37,38,65,0.7)] shadow-2xl h-[500px] w-[300px] m-5">
        ...
        <div class="px-5 pt-5">
          ...
          <button class="text-white font-bold flex my-6" routerLink="/arequests">Pending Requests</button>
      ...
      <div class="border border-black-600 rounded-xl shadow-2xl ml-[140px] m-5 p-5 w-full">
        <h1 class="text-center font-bold text-2xl mb-6">Pending Parcel Requests</h1>
...
export class AdminSentRequests {
